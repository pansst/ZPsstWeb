...
public class BaseDaoImpl<T> implements BaseDaoI<T> {
	...
	@Override
	public Serializable saveNow(T o) {
		if (o != null) {
	...
	@Override
	public List<Object[]> findBySql(String sql, int start, int rows) {
		SQLQuery q = this.getCurrentSession().createSQLQuery(sql);
		return q.setFirstResult(start).setMaxResults(rows).list();
	}
	...
	@Override
	public List<Object[]> findBySql(String sql, Map<String, Object> params, int start, int rows) {
		SQLQuery q = this.getCurrentSession().createSQLQuery(sql);
		if ((params != null) && !params.isEmpty()) {
			for (String key : params.keySet()) {
				Object object = params.get(key);
